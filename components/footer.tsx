        ...
        <>
            <div className="p-6 md:p-10 lg:p-15 bg-ink flex flex-col md:flex-row items-start gap-6 md:gap-8 lg:gap-12 justify-between">
                ...
                <div className="flex flex-col w-full md:w-auto">
                    ...
                    <p className="font-lexend font-light text-cream/40 ml-2 md:ml-3 text-xs mt-1" aria-hidden="true">
                        美味しい — oishii
                    </p>
                    <Link href={"https://www.facebook.com/profile.php?id=61555476440699"} target="_blank" rel="noopener noreferrer" className="w-fit">
                        <svg xmlns="http://www.w3.org/2000/svg" height="30" width="30" fill="currentColor" className="text-cream hover:text-white transition-colors cursor-pointer ml-2 md:ml-3 mt-3" viewBox="0 0 16 16">
