...
import storefront from "@/public/images/store.webp";
        ...
        <>
            ...
            <section className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pt-14 md:pt-20 pb-20 md:pb-28">
                <div className="flex flex-col lg:flex-row items-start justify-center gap-12 lg:gap-20">
                    <Reveal variant="left" className="relative w-full max-w-125 shrink-0 mx-auto lg:mx-0">
                        <Image
                            src={storefront}
                    ...
                    <div className="flex flex-col gap-5 w-full max-w-2xl lg:w-1/2 pt-10 lg:pt-0">
                        <Reveal as="span" variant="fade" className="font-lexend text-xs md:text-sm tracking-[0.25em] uppercase text-navy/50">
                            オーナー — The Owner
                        </Reveal>
                        <Reveal as="h2" delay={0.08} className="font-league font-bold text-navy text-4xl md:text-5xl mb-2">
                            Meet Yia Thao
                        </Reveal>

                        <Reveal as="p" delay={0.16} className="font-lexend font-light text-navy/80 text-sm md:text-base leading-relaxed">
                        ...
                        <Reveal as="p" delay={0.22} className="font-lexend font-light text-navy/80 text-sm md:text-base leading-relaxed">
                        ...
                        <Reveal as="p" delay={0.28} className="font-lexend font-light text-navy/80 text-sm md:text-base leading-relaxed">
                        ...
                        <Reveal delay={0.34} className="mt-4 flex flex-wrap items-center gap-4">
                            <Link
                                href={"/menu"}
